...
export const PHONE_MARKETING_CONSENT =
  'By entering your phone number and using PLUR NYC rooms, you agree to receive recurring ' +
  'automated marketing and account text messages (such as event drops and ticket info) from ' +
  'PLUR NYC at the number you provide, including messages sent using an automatic telephone ' +
...
export const PHONE_CONSENT_CHECKBOX =
  'I agree to receive recurring automated marketing & account texts from PLUR NYC at this ' +
