...
const fullTime = (iso: string) => new Date(iso).toLocaleString('en-US', { weekday: 'short', month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit' });
  ...
  return (
    <div className="shell"><div className="main">
      ...
      <div className="card" style={{ padding: 20 }}>
        ...
        <div className="meta" style={{ marginTop: 6 }}>{fullTime(e.startTime)}</div>
        {e.location && <div className="meta" style={{ marginTop: 4 }}>{e.location}</div>}
